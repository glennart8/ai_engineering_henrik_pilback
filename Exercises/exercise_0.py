...
df_electric = df.dropna(subset=["Import_Electric"])

# Skapa en ny datekolumen med år och månad som strings

# df_electric["Date"] = pd.to_datetime(df_electric["Year"].astype(str) + "-" + df_electric["Month"].astype(str))

# plt.figure(figsize=(12,6))
# plt.plot(df_electric["Date"], df_electric["Import_Electric"], marker="o")
# plt.title("Electric Cars Import per Month")
# plt.xlabel("Date")
# plt.ylabel("Imported Electric Cars")
